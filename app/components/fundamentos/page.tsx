...
const definiciones = [
  {
    ...
    def: "Una forma particular de guardar y organizar la información en un ordenador de forma que pueda ser usada eficientemente.",
    tag: "data_structure.h",
  },
  {
    term: "Contenedor",
    def: "Una estructura de datos que sirve para guardar colecciones de otros objetos.",
    tag: "container.h",
  },
  {
    term: "Tipo de dato abstracto (TDA)",
    def: "Un modelo matemático para una estructura de datos definida indirectamente por las operaciones que la manejan.",
    tag: "adt.h",
  },
  {
    term: "Clase de objetos",
    def: "La representación de un TDA que se hace en un lenguaje orientado a objetos.",
    tag: "class.h",
  },
];
    ...
    <main className="max-w-6xl mx-auto px-6 py-12 md:py-20">
      ...
      <section className="mb-20">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          />
          <ClassificationGroup
            title="Dimensionalidad"
            comment="dimensionality"
            categories={[
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <TermCard filename="search.cpp">
            ...
            <TechList>
              <TechItem bullet="→">
                Por un campo: <strong>árboles AVL, tablas hash, EEDD en ficheros</strong>.
              </TechItem>
              <TechItem bullet="→">
                Por dos o más campos: <strong>quadtree, mallas regulares</strong>.
              </TechItem>
            </TechList>
          </TermCard>
          <TermCard filename="access.cpp">
            ...
            <TechList>
              <TechItem bullet="→">
                Dato siempre en misma posición: <strong>pilas, colas, colas con prioridad</strong>.
              </TechItem>
              <TechItem bullet="→">
                Problemas de caminos: <strong>grafos</strong>.
              </TechItem>
            </TechList>
          </TermCard>
        </div>
      ...
      <div className="text-center py-12 bg-subtle rounded-lg border border-border-warm">
        <div className="font-mono text-sm text-amber mb-2">
          // todo: next_section
        </div>
        <p className="text-ink-soft">
          Próximo paso: notaciones asintóticas (O, Ω, Θ), gráfica interactiva de
          órdenes de complejidad y cálculo paso a paso.
        </p>
      </div>
    </main>
  );
